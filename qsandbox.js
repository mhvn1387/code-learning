...
const questions = [
    {
        title : 'What tag do we use for the image ?',
        options : [
            'div tag', 
            'img tag', 
            'p tag', 
    ...
    {
        title : 'In what case we can not add controllers to the video tag ?',
        options : [
            'video',
            'video + controls',
            'video + controls loop',
    ...
    {
        title : 'Which tag do we use for the paragraph ?',
        options : [
            'a tag',
            'i tag',
            'p tag',
    ...
    {
        title : 'To put the source of a photo in the img tag, which property should we put equal to the link or location of the image ?',
        options : [
            'href',
            'height',
            'src',
    ...
    {
        title : 'Which tag is not related to the list ?',
        options : [
            'li tag',
            'ul tag',
            'ol tag',
...
function init() {
    ...
    <div class="btns" style="float: right;">
        <button style="float: right;" type="button" onclick="location.href='quizzes.html'">Back to Quizzes Page</button>
    </div>
        <div class="app-body">
            ...
            <button  style="float: left;">Restart</button>
            <h3 style="float: right; color: rgb(255, 0, 0);" class="score"></h3>
        </div>
    `;
